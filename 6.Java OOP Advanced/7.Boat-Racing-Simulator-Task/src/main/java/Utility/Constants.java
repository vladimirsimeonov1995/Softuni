...
public class Constants
{
    ...
    public static final int THE_NUMBER_ZERO = 0;

    public static final int MinNumberOfParticipants = 3;

    public static final Double NegativeTime = -1.0;

    public static final String ENIND_COMMAND = "End";
}
