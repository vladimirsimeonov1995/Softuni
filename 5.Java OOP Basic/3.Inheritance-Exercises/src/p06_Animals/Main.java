...
public class Main {
    ...
    private static void makeAnimals(BufferedReader reader, String infoForAnimalType) throws IOException {
        ...
        switch (infoForAnimalType){
            case "Animal" :
                try{
                    Animal animal = new Animal(animalInfo[0],animalInfo[1],animalInfo[2]);
            ...
            case "Dog":
                try{
                    Dog dog = new Dog(animalInfo[0],animalInfo[1],animalInfo[2]);
                    System.out.println(infoForAnimalType);
                    System.out.printf("%s %s %s\n",animalInfo[0],animalInfo[1],animalInfo[2]);
            ...
            case "Cat":
                try{
                    Cat cat = new Cat(animalInfo[0],animalInfo[1],animalInfo[2]);
                    System.out.println(infoForAnimalType);
                    System.out.printf("%s %s %s\n",animalInfo[0],animalInfo[1],animalInfo[2]);
            ...
            case "Frog":
                try{
                    Frog frog = new Frog(animalInfo[0],animalInfo[1],animalInfo[2]);
                    System.out.println(infoForAnimalType);
                    System.out.printf("%s %s %s\n",animalInfo[0],animalInfo[1],animalInfo[2]);
            ...
            case "Kitten":
                try{
                    Kitten kitten = new Kitten(animalInfo[0],animalInfo[1]);
                    System.out.println(infoForAnimalType);
            ...
            case "Tomcat":
                try{
                    Tomcat tomcat = new Tomcat(animalInfo[0],animalInfo[1]);
                    System.out.println(infoForAnimalType);
